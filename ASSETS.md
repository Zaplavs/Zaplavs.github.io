...
`public/assets/works/*.jpg` — снимки главных экранов сайтов, которые я спроектировал и собрал: «Тунец», Lotus Vie, «Империя», «Рыжая кошка» и «Лавли». Сняты headless-браузером с локальных копий проектов при ширине 1440 px, сохранены в JPEG.
